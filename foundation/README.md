...
Canonical intellectual base of the Genshi framework: why it exists, what it believes, how concepts are structured, and how the framework itself is governed.

## Contents

| Area | Purpose |
|------|---------|
| [thesis/](thesis/) | Constitutional text (manifesto) |
